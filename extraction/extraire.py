...
def extraire_cv(texte_cv, nom_fichier=""):
    prompt = f"""
    ...
    try:
        ...
        data["extraction_method"]  = "llm_groq_llama3"
        data["temps_reponse_sec"]  = duree
        data["succes"]             = True
        data["erreur"]             = None
        print(f"✅ Extraction Groq réussie pour {nom_fichier} ({duree}s)")
        return data
        ...
        return {
            ...
            "extraction_method" : "llm_groq_llama3",
...
if __name__ == "__main__":
    ...
    dossier_sortie = r"C:\Users\user\pfe_mails\resultats\groq"
    ...
    with open(os.path.join(dossier_sortie, "_tous_les_resultats_groq.json"), "w", encoding="utf-8") as f:
        json.dump(sortie_globale, f, ensure_ascii=False, indent=2)
 
    with open(os.path.join(dossier_sortie, "_metriques_groq.json"), "w", encoding="utf-8") as f:
